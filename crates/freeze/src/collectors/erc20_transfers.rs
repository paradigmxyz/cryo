use crate::{
    ...
    ColumnEncoding, ColumnType, Datatype, Erc20Transfers, Params, Schemas, Source, Table, ToVecU8,
    U256Type, EVENT_ERC20_TRANSFER,
};
use ethers::prelude::*;
use polars::prelude::*;
...
pub fn process_erc20_transfers(logs: Vec<Log>, columns: &mut Erc20TransferColumns, schema: &Table) {
